...
5. **Configure your opencode.json**:
   After authenticating, you can configure GitHub Copilot in your `~/.kctx/opencode/config/opencode.json` file. See the [OpenCode GitHub Copilot documentation](https://opencode.ai/docs/providers) for the exact configuration format.
