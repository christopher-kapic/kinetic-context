...
export const env = createEnv({
  server: {
    ...
    OPENCODE_TIMEOUT_MS: z.coerce.number().default(180000), // 3 minutes, less than opencode's 5-minute provider timeout
    OPENCODE_FETCH_TIMEOUT_MS: z.coerce.number().default(180000), // 3 minutes
